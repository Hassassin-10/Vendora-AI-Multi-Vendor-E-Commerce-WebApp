...
const Footer = () => {
  ...
  const linkSections = [
    {
      ...
      links: [
        ...
        { text: "Smartphones", path: "/shop?category=Smartphones", icon: null },
        { text: "Laptops", path: "/shop?category=Laptops", icon: null },
      ],
    },
    {
      title: "WEBSITE?",
  ...
  return (
    <footer id="contact-section" className="mx-6 bg-white">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to Vendora, your ultimate destination for the latest and
